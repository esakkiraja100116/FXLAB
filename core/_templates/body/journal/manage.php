        ...
        <table id="zero-config" class="table table-striped" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <?php $publish = $values['published'];
                        if($publish == '0'){
                            ?>
                    <td><span class="badge badge-warning"> not published </span></td>
                    <?
                        }
                        if($publish == '1'){
                            ?>
                    <td><span class="badge badge-success"> publised </span></td>
                    <?
                        } 
                       ?>
