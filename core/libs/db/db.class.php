...
class Unique
{
    ...
    {        
        ...
        LEFT JOIN team
        ON user.id = team.id WHERE user.name NOT IN (Select team.user_one from team UNION Select team.user_two from team UNION Select team.user_three from team UNION Select team.user_four from team)";
